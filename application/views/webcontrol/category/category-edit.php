      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php
            ...
            echo form_open('webcontrol/category/edit/'.$this->uri->segment(4));
          ?>
            <div class="box-body">
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown('category_area', $options, set_value('category_area', $category['area_id']), $data);
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('category_name', $category['kategori']));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('category_quota', $category['kuota']));
                ?>
