      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php
            ...
            echo form_open_multipart('webcontrol/admin/edit/'.$this->uri->segment(4));
          ?>
            <div class="box-body">
              <?php
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('admin_name', $admin['admin_name']));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('admin_email', $admin['admin_email']));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown('admin_level', $options, set_value('admin_level', $admin['admin_level']), $data);
                ?>
