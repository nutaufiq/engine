      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php
            ...
            echo form_open('webcontrol/p3b/edit/'.$this->uri->segment(4));
          ?>
            <div class="box-body">
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('p3b_country', $p3b['p3b_country'], FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('p3b_date_signed', $p3b['p3b_date_signed'], FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('p3b_date_effective', $p3b['p3b_date_effective'], FALSE));
                ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_header_id', $p3b['p3b_header_id'], FALSE));
                    ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_header_en', $p3b['p3b_header_en'], FALSE));
                    ?>
            ...
            for($i = 0 ; $i < 40 ; $i++)
            {
              if(array_key_exists($i, $p3b_article))
              {
                $p3b_article_chapter = $p3b_article[$i]['p3b_article_chapter'];

                $p3b_article_chapter_title_id = $p3b_article[$i]['p3b_article_chapter_title_id'];
                $p3b_article_chapter_title_en = $p3b_article[$i]['p3b_article_chapter_title_en'];
                
                $p3b_article_title_id = $p3b_article[$i]['p3b_article_title_id'];
                $p3b_article_title_en = $p3b_article[$i]['p3b_article_title_en'];
                
                $p3b_article_content_id = $p3b_article[$i]['p3b_article_content_id'];
                $p3b_article_content_en = $p3b_article[$i]['p3b_article_content_en'];
              }
              else
              {
                $p3b_article_chapter = 0;

                $p3b_article_chapter_title_id = "";
                $p3b_article_chapter_title_en = "";
                
                $p3b_article_title_id = "";
                $p3b_article_title_en = "";
                
                $p3b_article_content_id = "";
                $p3b_article_content_en = "";
              }
            ?>
              <hr>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_dropdown('p3b_chapter[]', $options, set_value('p3b_chapter[]', $p3b_article_chapter), $data);
                    ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_input($data, set_value('p3b_chapter_title_id[]', $p3b_article_chapter_title_id, FALSE));
                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_input($data, set_value('p3b_article_title_id[]', $p3b_article_title_id, FALSE));
                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_article_content_id[]', $p3b_article_content_id, FALSE));
                    ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_input($data, set_value('p3b_chapter_title_en[]', $p3b_article_chapter_title_en, FALSE));
                    ?>
                    <?php echo form_error('p3b_chapter_title_id[]'); ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_input($data, set_value('p3b_article_title_en[]', $p3b_article_title_en, FALSE));
                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_article_content_en[]', $p3b_article_content_en, FALSE));
                    ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_protocol_id', $p3b['p3b_protocol_id'], FALSE));
                    ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php
                      ...
                      echo form_textarea($data, set_value('p3b_protocol_en', $p3b['p3b_protocol_en'], FALSE));
                    ?>
