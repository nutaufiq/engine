      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php
            ...
            echo form_open('webcontrol/mahkamahagung/add');
          ?>
            <div class="box-body">
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('ma_number', null, FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('ma_year', null, FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_textarea($data, set_value('ma_content', null, FALSE));
                ?>
