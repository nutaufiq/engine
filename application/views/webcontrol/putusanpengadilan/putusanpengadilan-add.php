      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php
            ...
            echo form_open('webcontrol/putusanpengadilan/add');
          ?>
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('tahun_keputusan', null, FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('tahun_pajak', null, FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_input($data, set_value('jenis_pajak', null, FALSE));
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_textarea($data, set_value('isi_putusan', null, FALSE));
                ?>
